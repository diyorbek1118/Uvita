...
final class PaymeWebhookHandler
{
    ...
    private function verifySignature(Request $request): void
    {
        ...
        if ($expectedKey === '' && ! config('payment.test_mode')) {
            throw new InvalidSignatureException('Payme production key is not configured');
        }

        if ($login !== self::LOGIN || ($expectedKey !== '' && ! hash_equals($expectedKey, $password))) {
