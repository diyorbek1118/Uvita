    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'payment' => $this->whenLoaded('latestPayment', fn () => $this->latestPayment ? [
                ...
                'provider' => $this->latestPayment->provider->value,
                'refund_requested_at' => $this->latestPayment->refund_requested_at?->toISOString(),
                'refunded_at' => $this->latestPayment->refunded_at?->toISOString(),
            ] : null),
