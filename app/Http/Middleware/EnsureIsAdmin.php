...
final class EnsureIsAdmin
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (!($user instanceof Staff) || ($user->role !== StaffRole::ADMIN && $user->role !== StaffRole::SUPER_ADMIN)) {
            return response()->json(['message' => 'Bu sahifaga faqat adminlar kirishi mumkin'], 403);
        }
